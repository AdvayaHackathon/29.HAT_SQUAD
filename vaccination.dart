...
class VaccinationPage extends StatelessWidget {
  final List<Map<String, String>> vaccinations = [
    ...
    },
    {
      ...
      'description': 'Protects mother and baby from tetanus, diphtheria, and whooping cough.',
    ...
    },
    {
      'month': 'Month 8',
      'name': 'Hepatitis A',
      'description': 'Prevents foodborne liver infections especially in regions with poor sanitation.',
    ...
    },
    {
      ...
      'description': 'Final dose ensures complete immunity against Hepatitis B.',
  ...
  void sendSMS(BuildContext context, String message) async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Unable to send SMS.')),
      );
    }
  }
                      ...
                      children: [
                        ...
                        RichText(
                          text: TextSpan(
                            style: TextStyle(fontSize: 16, color: Colors.blue.shade900),
                            children: [
                              TextSpan(text: "Cause: ", style: TextStyle(fontWeight: FontWeight.bold)),
                        ...
                        RichText(
                          text: TextSpan(
                            style: TextStyle(fontSize: 16, color: Colors.blue.shade900),
                            children: [
                              TextSpan(text: "Prevention: ", style: TextStyle(fontWeight: FontWeight.bold)),
                        ...
                        Center(
                          child: ElevatedButton.icon(
                            onPressed: () async {
                              ...
                              final msg = 'Reminder: ${v['name']} is scheduled for ${v['month']}.';
                              sendSMS(context, msg);
