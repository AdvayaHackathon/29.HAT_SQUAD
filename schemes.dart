...
Widget build(BuildContext context) {
  return MaterialApp(
    title: 'Baby Care Resources',
    theme: ThemeData(
      primarySwatch: Colors.pink,
      useMaterial3: true,
    ),
    home: const BabyCareOptionsPage(),
  );
}

class BabyCareOptionsPage extends StatefulWidget {
  const BabyCareOptionsPage({super.key});

  @override
  State<BabyCareOptionsPage> createState() => _BabyCareOptionsPageState();
}

class _BabyCareOptionsPageState extends State<BabyCareOptionsPage> {
  ...
  Widget _buildResourceDropdown() {
    final resources = selectedOption == 'pregnancy'
    ...
    return Column(
      ...
      children: [
        ...
        DropdownButtonFormField<String>(
          ...
          items: resources.keys.map((String key) {
