...
class _TextRecognitionPageState extends State<TextRecognitionPage> {
  ...
  Future<void> _analyzeTextWithCohere() async {
    ...
    try {
      final String apiKey = 'uziKmpzc4aOCI1f2tIiUrjJGkqnPOXXpJHvc4hNv'; // Replace with your Cohere API key
      ...
      final response = await http.post(
        ...
        body: jsonEncode({
          'prompt': 'Analyze the following text and identify possible diseases or health risks: $_extractedText',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Colors.orange[100], // Orange shade 100 background
      appBar: AppBar(
        title: Text(
          'Recognized Text',
          style: TextStyle(color: Color(0xFF0D70A1), fontWeight: FontWeight.bold, fontSize: 20),
        ),
        backgroundColor: Colors.orange[100], // Match app bar background to overall background
        elevation: 0, // Remove shadow for a seamless look
        actions: [
          IconButton(
            icon: Icon(
              _isLoading ? Icons.stop : Icons.play_arrow,
              color: Color(0xFF0D70A1), // Blue-green icon color
            ),
                ...
                : Padding(
                    ...
                    child: Card(
                      ...
                      child: Container(
                        ...
                        padding: const EdgeInsets.all(24.0), // Reasonable padding
                            ...
                            children: [
                              Text(
                                ...
                                style: TextStyle(
                                  ...
                                  color: Color(0xFF0D70A1), // Blue-green title color
                                ),
                              ),
                              const SizedBox(height: 16), // Spacing between title and text
                              Text(
            ...
            child: ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                ...
                shape: RoundedRectangleBorder(
                  ...
                  side: BorderSide(color: Color(0xFF0D70A1), width: 2), // Add border for visibility
                ),
              ),
              child: _isAnalyzing
                  ? Row(
                      ...
                      children: [
                        CircularProgressIndicator(
                          color: Color(0xFF0D70A1), // Blue-green progress indicator
                        ),
                        const SizedBox(width: 10),
                        Text(
                          'Analyzing...',
                          style: TextStyle(fontSize: 18, color: Color(0xFF0D70A1)), // Blue-green text
                        ),
                      ],
                    )
                  : Text(
