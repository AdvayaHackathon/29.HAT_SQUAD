...
class Sosk extends StatelessWidget {
  const Sosk({super.key});
...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('SOS App'),
        backgroundColor: const Color.fromARGB(255, 167, 28, 128), // Dark pink app bar
      ),
      body: Container(
        decoration: BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [Colors.pink[50]!, Colors.pink[100]!], // Light pink gradient
          ),
        ),
        child: Center(
          child: Column(
              ...
              Padding(
                ...
                child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    ...
                    backgroundColor: const Color.fromARGB(255, 167, 28, 128), // Dark pink button color
  ...
  void _callAmbulance(BuildContext context) async {
    ...
    String ambulanceNumber = '+919481032460'; // Replace with the actual ambulance number
